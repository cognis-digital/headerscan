...
[![PyPI](https://img.shields.io/pypi/v/cognis-headerscan.svg)](https://pypi.org/project/cognis-headerscan/)
[![CI](https://github.com/cognis-digital/headerscan/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/headerscan/actions)
...
HEADERSCAN exists for one job — grade http security headers (csp/hsts/xfo) a-f from a response dump — and does it without a SaaS bill or heavyweight setup.
...
```bash
headerscan --version
headerscan scan .                      # scan the current project
headerscan scan . --format json
headerscan scan . --fail-on high       # non-zero exit for CI gates
headerscan mcp                         # expose as an MCP server (Cognis.Studio / Claude Desktop / Cursor)
```
...
Built in the spirit of **securityheaders.com**, re-framed for the Cognis approach: single-purpose, self-hostable,
MCP-native, and unified with the rest of the Suite. Missing a credit? Open a PR.

## How it fits the Cognis Neural Suite

`headerscan` is one of the **100+ tools** in the [Cognis Neural Suite](https://github.com/cognis-digital).
