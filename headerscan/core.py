"""HEADERSCAN core — Grade HTTP security headers (CSP/HSTS/XFO) A-F from a response dump."""
...
RULES = [
    ("HEA-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("HEA-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("HEA-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
