#!/usr/bin/env sh
# Universal installer for headerscan. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/headerscan.git"
echo "Installing headerscan ..."
